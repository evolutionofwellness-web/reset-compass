// app.js — restored v25 baseline with corrected escaping and no syntax errors
...
function escapeJs(s) {
  // Escape single and double quotes so strings inserted in onclick/template literals are safe.
