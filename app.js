/* app.js v127 — CSS-only enhancements (taller accent, larger icon, stronger contrast, no animations)
   - ES5-friendly
...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    try {
      ...
      renderRoute();
      updateStreak();
      console.info('[app v127] initialized (CSS-only enhancements: taller accent, larger icons, stronger contrast, no animations)');
    } catch (err) {
